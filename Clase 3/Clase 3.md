...
Aquí tienes una versión combinada de los conceptos y ejercicios, organizada de manera lógica para enseñar y practicar ramas en Git. Incluye gráficos en Markdown para facilitar la comprensión.
...
Una rama en Git es una línea de desarrollo separada que te permite trabajar en características o correcciones sin afectar la rama principal (normalmente `master` o `main`).
